...
$sql = "INSERT INTO ServiceProvider (SPname, SPemail, SPpassword, SPaddress, SPphone, SPprofilePic, SPserviceType, SPavailability, locationID)
        VALUES ('$name', '$email', '$password', '$address', '$phone', '$profilePic', '$serviceType', '$availability', $locationID)";
